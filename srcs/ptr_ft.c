...
/*   Updated: 2017/02/02 13:33:56 by aoudin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_addr_pfonct_key(t_f *t_fol)
{
	...
	t_fol->pfonct_key[15] = &ft_red;
	t_fol->pfonct_key[17] = &ft_red;
	t_fol->pfonct_key[5] = &ft_green;
	t_fol->pfonct_key[4] = &ft_green;
	t_fol->pfonct_key[11] = &ft_blue;
	t_fol->pfonct_key[45] = &ft_blue;
